...
![preview](https://raw.githubusercontent.com/kumarujjwalm/ujjwalkumar.dev/main/thumbnail.png)
...
```bash
$ git clone https://github.com/kumarujjwal959/portfolio.git
$ cd ujjwalkumar.dev
$ npm install
$ npm run dev
```
...
Licensed under the [MIT license](https://github.com/kumarujjwal959/portfolio/blob/main/LICENSE).
